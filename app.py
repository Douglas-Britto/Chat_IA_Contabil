...
def responder_ia(pergunta, documentos, grafico_nome=None):
    contexto_grafico = f"O gráfico solicitado é '{grafico_nome}'. Analise esse gráfico com base nos documentos disponíveis." if grafico_nome else ""
    prompt = f"""
Você é um auditor fiscal inteligente. Analise os documentos abaixo e, se houver um gráfico mencionado, gere um resumo lógico sobre ele.
